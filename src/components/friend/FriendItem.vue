<template>
  <div class="friend-item" :class="active ? 'active' : ''" @contextmenu.prevent="showRightMenu($event)">
    <div class="friend-avatar">
      <head-image :name="friend.nickName" :url="friend.headImage" :online="friend.online"></head-image>
    </div>
    <div class="friend-info">
      <div class="friend-name">{{ friend.nickName }}</div>
      <div class="friend-online">
        <el-image v-show="friend.onlineWeb" class="online-iocn" :src="require('@/assets/image/online_web.png')"
          title="电脑设备在线" />
        <el-image v-show="friend.onlineApp" class="online-iocn" :src="require('@/assets/image/online_web.png')"
          title="移动设备在线" />
      </div>
    </div>
